...
$idusr=$_GET["id"];
$dis_usr="SELECT * FROM pa WHERE ID='$idusr'";
                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                ...
                                <!-- Form -->
                                <form method ="post" action="processpa.php"> 
                                    <div class="form_wrap">

                                        
                                        <div class="input_wrap">
                                            <label for="ic">IC </label>
                                            <input type="text" name="uic" value="<?php echo $row["Ic_Pa"];?>" required>
                                        </div>
                                        <div class="input_wrap">
                                        ...
                                        <div class="input_wrap">
                                            ...
                                            <input type="text" id="unotel"  name  = "unotel"  value="<?php echo $row["No_tel"];?>" required>
                                        </div>
