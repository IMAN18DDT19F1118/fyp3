...
$idusr=$_GET["id"];
$dis_usr="SELECT * FROM pelajar WHERE ID='$idusr'";
                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                ...
                                <!-- Form -->
                                <form method = "POST" action="processpelajar.php">
                                    <div class="form_wrap">
                                    <div class="input_wrap">
                                            <label for="uicpelajar">IC </label>
                                            <input type="text" id="uic"  name  = "uic" value="<?php echo $row["IC_Pelajar"];?>" required>
                                        </div>
                                        <div class="input_wrap">
                                            <label for="unama">Nama Penuh </label>
                                            <input type="text" id="unama"  name  = "unama" value="<?php echo $row["Nama"];?>" required>
                                        </div>
                                        ...
                                        <div class="input_wrap">
                                            <label for="unopend">No Pendaftaran</label>
                                            <input type="text" id="unopend"  name  = "unopend"  value="<?php echo $row["NoPendaftaran"];?>" required>
                                        </div>
                                        <div class="input_wrap">
                                            <label for="uemail">Email</label>
                                            <input type="text" id="uemail"  name  = "uemail"  value="<?php echo $row["email"];?>" required>
                                        </div>
                                        ...
                                        <div class="input_wrap">
                                            ...
                                            <input type="submit" value="Update" class="submit_btn" name = "submit_btn"><br><br>
                                            <input type="reset" value="Cancel" class="submit_btn" name = "cancelbtn">
