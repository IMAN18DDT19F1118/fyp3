                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                <!-- Title -->
                                <div class="title">
                                    Daftar Penasihat Akademik
                                </div>

                                <!-- Form -->
                                <form method ="post" action="addpa.php"> 
                                    <div class="form_wrap">
                                        ...
                                        <div class="input_wrap">
                                            ...
                                            <input type="text" id="notel"  name  = "notel" placeholder="No Telefon " required>
                                        </div>
                                        ...
                                        <div class="input_wrap">
                                        <center>
                                        <a class="view" href="displaypa.php">Senarai</a>
                                        </center>
                                        </div>
