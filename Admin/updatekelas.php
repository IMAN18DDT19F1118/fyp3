...
$idusr=$_GET["id"];
$dis_usr="SELECT * FROM kelas WHERE ID='$idusr'";
                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                ...
                                <!-- Form -->
                                <form method ="post" action="processkelas.php"> 
                                    <div class="form_wrap">
                                        ...
                                        <div class="input_wrap">
                                            ...
                                            <select name="ujabatan" id="ujabatan" class="select" value="<?php echo $row["Jabatan"];?>" required>
                                                    <option value="jtmk">Jabatan Teknologi Maklumat Dan Komunikasi</option>
                                                    <option value="jte">Jabatan Kejuruteraan Elektrik</option>
                                                    <option value="jp">Jabatan Perdagangan</option>
                                                    <option value="jrkv">Jabatan Rekabentuk dab Komunikasi Visual</option>
                                                    <option value="jph">Jabatan Pelancongan dan Hospitaliti</option>
                                                    
                                            </select>
                                        </div>
                                        <div class="input_wrap">
                                            <label for="unama">Nama Kelas </label>
                                            <input type="text" id="unama"  name ="unama"value="<?php echo $row["namakelas"];?>" required>
                                        </div>
