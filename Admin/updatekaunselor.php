...
$idusr=$_GET["id"];
$dis_usr="SELECT * FROM kaunselor WHERE ID='$idusr'";
                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                ...
                                <!-- Form -->
                                <form method ="post" action="processkaunselor.php"> 
                                    <div class="form_wrap">

                                        
                                        <div class="input_wrap">
                                            <label for="ic">IC </label>
                                            <input type="text" name="uic" value="<?php echo $row["IcKaunselor"];?>" required>
                                        </div>
                                        <div class="input_wrap">
                                            <label for="unama">Nama Penuh </label>
                                            <input type="text" name="unama" value="<?php echo $row["Nama"];?>" required>
                                        </div>

                                        
                                        <div class="input_wrap">
                                            <label for="passw">Kata Laluan</label>
                                            <input type="passsword" id="passw"  name ="upassw" value="<?php echo $row["katalaluan"];?>" required>
                                        </div>
