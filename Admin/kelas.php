                    ...
                    <div class="row">
                        <div class="wrapper">
                            ...
                            <div class="registration_form">
                                ...
                                <!-- Form -->
                                <form method ="post" action="addkelas.php"> 
                                    <div class="form_wrap">
                                        ...
                                        <div class="input_wrap">
                                            <label for="fnama">Nama Kelas </label>
                                        ...
                                        <!-- Submit button -->
                                        <div class="input_wrap">
                                            <input type="submit" value="Daftar" class="submit_btn" name = "submit_btn">
                                        </div>
                                        <div class="input_wrap">
                                        <center>
                                        <a class="view" href="displaykelas.php">Senarai</a>
                                        </center>
                                        </div>
